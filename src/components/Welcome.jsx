...
const setupTextHover = (container, type) => {
    ...
    container.addEventListener("mousemove", hamdleMouseMove);
    container.addEventListener("mouseleave", handleMouseLeave);

    return () => {
        container.removeEventListener("mousemove", hamdleMouseMove);
...
const Welcome = () => {
    ...
    return (
        <section id="welcome">
            <p ref={subtitleRef}>{renderText("Hey, I'm Pavan! Welcome to my", "text-3xl font-georama", 100)}</p>
